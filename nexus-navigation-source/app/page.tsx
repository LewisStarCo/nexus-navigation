...
import { BrowserDataTransfer } from "@/src/modules/import-export/components/BrowserDataTransfer";
import {
...
export default function Home() {
  const { data, ready, storageError, setData, saveNow, exportData, importData, updateAndSave } = useNexusData();
      ...
      {settingsOpen && <div className="modal-layer" role="dialog" aria-modal="true" aria-label="管理资源">
        ...
        <aside className="manager">
          ...
          <div className="manager-scroll">
            ...
            <BrowserDataTransfer exportData={exportData} importData={importData} />
